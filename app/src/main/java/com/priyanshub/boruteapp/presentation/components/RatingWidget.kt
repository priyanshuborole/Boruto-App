package com.priyanshub.boruteapp.presentation.components
...
import com.priyanshub.boruteapp.ui.theme.EXTRA_SMALL_PADDING
import com.priyanshub.boruteapp.ui.theme.LightGray
import com.priyanshub.boruteapp.ui.theme.StarColor
            ...
            translate(left = left, top = top) {
                ...
                clipPath(path = starPath){
                    drawRect(
                        color = StarColor,
                        size = Size(
                            width = starPathBounds.width / 1.7f,
...
@Composable
fun StarPreview( ){
    RatingWidget(modifier = Modifier, rating = 1.0, scaleFactor = 1f)
}
